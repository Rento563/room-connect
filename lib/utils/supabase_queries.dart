...
class SupabaseQueries {
  ...
  static Future<String> uploadRoomImage(String roomId, Uint8List fileBytes, String fileName) async {
  ...
  static Future<List<Map<String, dynamic>>> getMessagesForOwner(String ownerId) async {
